...
public class StateDiagramGraph extends AbstractGraph
{
    ...
    static
    {
        ...
        pNode.setToolTip(rs.getString("node4.tooltip"));
        NODE_PROTOTYPES.add(pNode);

        SplitNode sNode = new SplitNode();
        sNode.setToolTip(rs.getString("node5.tooltip"));
        NODE_PROTOTYPES.add(sNode);

        CombineNode cNode = new CombineNode();
        cNode.setToolTip(rs.getString("node6.tooltip"));
        NODE_PROTOTYPES.add(cNode);
