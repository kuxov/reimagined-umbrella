...
public interface IGraphFile extends IFile
{
    ...
    void exportToAlpReport() throws SAXException, ClassNotFoundException, IOException, DocumentException, SQLException;

    public abstract void exportToAlp() throws ParserConfigurationException, IOException, SAXException, TransformerException;
