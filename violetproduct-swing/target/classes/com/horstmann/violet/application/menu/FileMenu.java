...
public class FileMenu extends JMenu
{
    ...
    private void initFileExportMenu()
    {
        ...
        initFileExportToAlpItem();
        initFileExportToAlpReportItem();
        ...
        this.fileExportMenu.add(this.fileExportToAlpItem);
        this.fileExportMenu.add(this.fileExportToAlpReportItem);
    ...
    private void initFileExportToAlpItem()
    {
        this.fileExportToAlpItem.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                IWorkspace workspace = (Workspace) mainFrame.getActiveWorkspace();
                ...
                {
                    try {
                        workspace.getGraphFile().exportToAlp();
    ...
    private void initFileExportToAlpReportItem()
    {
        this.fileExportToAlpReportItem.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                IWorkspace workspace = (Workspace) mainFrame.getActiveWorkspace();
                ...
                {
                    try {
                        workspace.getGraphFile().exportToAlpReport();
                    } catch (SAXException | ClassNotFoundException | DocumentException | IOException | SQLException ex) {
                        throw new RuntimeException(ex);
                    }
                }
            }
    ...
    @ResourceBundleBean(key = "file.export_to_alp")
    private JMenuItem fileExportToAlpItem;

    @ResourceBundleBean(key = "file.export_to_alp_report")
    private JMenuItem fileExportToAlpReportItem;
